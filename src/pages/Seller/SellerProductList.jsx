...
const SellerProductList = () => {
  ...
  const [createProduct] = useSellerCreateProductMutation();
          ...
          <div className="p-3">
            <div className="flex flex-wrap">
              <div className="one">
                ...
                <input
                  type="text"
                  className="p-4 mb-3 w-[30rem] border rounded-lg bg-[#fffff] text-black"
                  value={name}
            ...
            <textarea
              type="text"
              className="p-2 mb-3 bg-[#fffff] border rounded-lg w-[95%] text-black"
              value={description}
